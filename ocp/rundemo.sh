...
project_name=kerberos-$rand_name
...
echo $admin_pwd | oc rsh -c kinit-sidecar $app_pod kadmin -r $realm -p admin/admin@$realm -q "addprinc -randkey MSSQLSvc/msql.example.com:1433@EXAMPLE.COM"
